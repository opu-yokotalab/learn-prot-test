...
>
	...
	<xsl:attribute-set name="submitAnswer">
		...
		<xsl:attribute name="onClick"><xsl:text>javascript:set_evaluate(this); return false</xsl:text></xsl:attribute>
	 	<xsl:attribute name="onKeypress"><xsl:text>javascript:set_evaluate(this); return false</xsl:text></xsl:attribute>
	</xsl:attribute-set>
	...
	<xsl:template match="exam">
		<html xml:lang="ja" lang="ja">
			<head>
				...
				<script type="text/javascript" src="./func/evaluate.js"><xsl:comment>hoge</xsl:comment></script>
			</head>
		<body>
