...
function pre_evaluate(obj) {
	...
	try {
		...
		pageURL = baseURL + "?mode=pre_evaluate&selected=" + obj.id + "&type=" + obj.getAttribute("type") + "&value=" + obj.value + "&ques_pkey=" + obj.getAttribute("ques_pkey");
	    } else if(obj.getAttribute("type") == "checkbox") {
		pageURL = baseURL+ "?mode=pre_evaluate&selected=" + obj.id + "&type=" + obj.getAttribute("type") + "&checked=" + obj.checked + "&ques_pkey=" + obj.getAttribute("ques_pkey");
